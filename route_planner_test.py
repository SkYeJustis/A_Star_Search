...
class TestRoutePlanner(unittest.TestCase):
    def setUp(self):
        self.map_10 = Map()
        self.map_10.intersections = {0: [0.7798606835438107, 0.6922727646627362],
        ...
        self.map_40 = Map()
        self.map_40.intersections = {0: [0.7801603911549438, 0.49474860768712914],
        ...
        self.map_40.roads = [[36, 34, 31, 28, 17],
